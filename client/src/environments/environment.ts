...
export const azureWebConfig: IonicAuthOptions = {
  ...
  discoveryUrl: 'https://io-ionic-presidio-demo.auth.us-east-1.amazoncognito.com/login?client_id=2jjnoj7qqq0ddeqadh7660ui48&response_type=code&scope=aws.cognito.signin.user.admin+email+openid&redirect_uri=http://localhost:8100/callback',
